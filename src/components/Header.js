    ...
    return (
        <div className="header">
            <div className="hamburger">
                <Hamburger toggled={isOpen} toggle={setOpen} size={30} className="hamburger-icon" />
            </div>
            <div className={isOpen ? "" : "hidden"}>
                <ul>
                    ...
                    <li className="header-list">
                        <Link className="header-link underline-transition" to="project" onClick={() => setOpen(false)}>
                            Project{" "}
                        </Link>
                    </li>
                    <li className="header-list">
